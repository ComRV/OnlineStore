<aside class="w-64 border-r ml-5" aria-label="Sidebar">
    ...
    <ul class="pt-4 mt-4 space-y-2 border-t border-gray-200 dark:border-gray-700">
      ...
      <li class="flex items-center mr-4">
        <input id="mancity" type="checkbox" value=""
          class="w-4 h-4 text-emerald-500 bg-gray-100 rounded border-gray-300 focus:ring-emerald-500 dark:focus:ring-emerald-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        <label for="mancity" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Manchester City</label>
      </li>
      <li class="flex items-center mr-4">
        <input id="liverpool" type="checkbox" value=""
          class="w-4 h-4 text-emerald-500 bg-gray-100 rounded border-gray-300 focus:ring-emerald-500 dark:focus:ring-emerald-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        <label for="liverpool" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Liverpool</label>
      </li>
      <li class="flex items-center mr-4">
        <input id="chelsea" type="checkbox" value=""
          class="w-4 h-4 text-emerald-500 bg-gray-100 rounded border-gray-300 focus:ring-emerald-500 dark:focus:ring-emerald-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        <label for="chelsea" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Chelsea</label>
      </li>
      <li class="flex items-center mr-4">
        <input id="manunited" type="checkbox" value=""
          class="w-4 h-4 text-emerald-500 bg-gray-100 rounded border-gray-300 focus:ring-emerald-500 dark:focus:ring-emerald-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        <label for="manunited" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Manchester
          United</label>
      </li>
    </ul>
  </div>
